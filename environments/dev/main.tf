...
module "application-gateway" {
  ...
  backend_address_pools = [
    {
      name  = "appgw-prod-eastus-bapool01" 
  ...
  backend_http_settings = [
    {
      name                  = "appgw-production-gateway-eastus-be-http-set1"
    ...
    {
      name                  = "appgw-prodgateway-eastus-be-http-set2"
  ...
  request_routing_rules = [
    {
      ...
      backend_http_settings_name = "appgw-production-gateway-eastus-be-http-set1"
      priority                   = 1
    }
  ]
